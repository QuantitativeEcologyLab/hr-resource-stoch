...
Extreme events [@logares_black_2012; @anderson_black-swan_2017] such as heat domes, blizzards, fires, disease outbreaks, and oil spills are important events which are hard to predict (i.e., highly stochastic) and can cause great population instability by causing mass die-offs that drastically reduce the size and genetic diversity of a population [e.g., @matkin_ongoing_2008; @murray_pathogens_2006; @widmer_effects_2004; @reed_frequency_2003; @hollings_trophic_2014; @ameca_y_juarez_natural_2012; @berger_climate_2018]. Managing the intensity of and frequency of extreme events (e.g., controlled burns) can increase the stability of a habitat while promoting habitat diversity and adaptations to the event [@staver_tree_2011; @tingley_pyrodiversity_2016; @nimmo_animal_2019].
...
\noindent This paper presents a new unifying framework for estimating the effects of resource abundance and stochasticity on animals' spatial needs. The hypotheses and methods we present allow researchers to generalize the effects resource abundance and stochasticity have on animals' spatial needs by building upon previous work rather than stating their results as *de novo* findings. Instead, one can test whether members of the same population or species behave similarly, and whether all members of the group have a common functional response [@ref]. Individuals and populations that were once thought to have markedly different behaviors and spatial needs may instead have a single common functional response but different levels of $\e(R)$ and $\var(R)$ [@examples].
...
The ability of a specialist or obligate symbiont to shift its home range or adapt will likely depend strongly on its food source's or associate's ability to move or adapt, too.
