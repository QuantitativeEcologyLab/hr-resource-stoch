...
\noindent In probability and statistics, random variables are defined by specifying the **distribution** the variable is assumed to follow. Since the variable is random, it can take multiple values, each with different probabilities. Commonly known distributions include the normal (i.e., Gaussian) distribution, the Student's T distribution, and the Bernoulli distribution.
