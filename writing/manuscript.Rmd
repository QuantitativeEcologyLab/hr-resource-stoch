...
Location-scale models are a class of statistical models that allow one to model the mean and variance of the response rather than only modeling the mean.

* location-scale models
* `mgcv`, `brms`
* choosing the best family
* choosing the right complexity of each term (maybe that's why @nilsen_can_2005 found contrasting results)
