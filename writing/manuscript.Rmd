...
csl: 'the-american-naturalist.csl' # use 'nature.csl' to count refs
# biblio-style: 'amnatnat'
fontsize: 12pt
indent: true
header-includes:
...
\noindent \textbf{References}: 141 <!-- counted by using nature csl -->
