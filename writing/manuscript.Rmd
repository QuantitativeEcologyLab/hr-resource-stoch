...
Additional information is provided in Appendix B, including the directed acyclical graph [see fig. B6 and @mcelreath_statistical_2016] we used to infer causal the mechanisms of changes in $H$ and estimate the direct effects of $\e(R)$ and $\var(R)$ on $H$ (contrast this with fig. C5 and the empirical case study below).
